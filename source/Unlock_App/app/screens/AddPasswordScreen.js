...
//   StyleSheet,
// } from "react-native";
// import { addPassword } from "../controllers/unlockController";
...
//     const response = await addPassword(newPassword, setResponseMessage, setResponseColor);
//   };
...
const AddPasswordScreen = () => {
  ...
  const handleAddPassword = async () => {
    await addPassword(newPassword, setResponseMessage, setResponseColor);
  };
